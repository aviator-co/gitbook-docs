...
Retrieve the current status of a [<mark style="color:blue;">Runbook</mark>](concepts/architecture-overview.md) by its number. The response includes the aggregate status, step counts, and any associated pull requests.
