...
<!-- TODO: Add screenshot of the Inbox dashboard -->
...
To snooze a PR, click the snooze icon on any PR row in your Inbox and select a duration.

<!-- TODO: Add screenshot of the snooze popover -->

## Repository filtering

If you work across multiple repositories, you can filter your entire Inbox by repository. The repository filter applies across all sections, letting you focus on PRs from a specific project.

<!-- TODO: Add screenshot of the repository filter -->
...
<!-- TODO: Add screenshot of GitHub account linking -->
